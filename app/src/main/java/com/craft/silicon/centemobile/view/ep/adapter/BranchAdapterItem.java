...
public class BranchAdapterItem extends ArrayAdapter<OnlineAccountProduct> {


    public BranchAdapterItem(@NonNull Context context,
                             int resource,
                             @NonNull List<OnlineAccountProduct> objects) {
    ...
    @Nullable
    @Override
    public OnlineAccountProduct getItem(int position) {
