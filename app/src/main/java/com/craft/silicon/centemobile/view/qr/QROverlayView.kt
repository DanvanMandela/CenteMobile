...
import com.craft.silicon.centemobile.databinding.BlockCameraOverlayLayoutBinding
...
internal class QROverlayView @JvmOverloads constructor(
    ...
    private val binding = BlockCameraOverlayLayoutBinding.inflate(LayoutInflater.from(context),this)
    private val grayColor = ContextCompat.getColor(context, R.color.dar_color_one)
    ...
    private fun getAccentColor(): Int {
        return TypedValue().let {
            if (context.theme.resolveAttribute(android.R.attr.colorAccent, it, true)) {
                ...
                ContextCompat.getColor(context, R.color.app_blue_dark)
            }
        }
    }
