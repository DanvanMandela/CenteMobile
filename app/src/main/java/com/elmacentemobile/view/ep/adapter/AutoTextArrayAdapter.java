...
import com.elmacentemobile.view.ep.adapter.holder.AutoTextViewHolder;
import com.elmacentemobile.view.ep.adapter.holder.TextLayoutViewHolder;


import java.util.List;

public class AutoTextArrayAdapter extends ArrayAdapter<StaticDataDetails> {


    public AutoTextArrayAdapter(@NonNull Context context, int resource, @NonNull List<StaticDataDetails> objects) {
    ...
    @Nullable
    @Override
    public StaticDataDetails getItem(int position) {
