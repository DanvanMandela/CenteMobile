...
import com.elmacentemobile.data.model.InsuranceData;
...
public class InsuranceAdapterItem extends ArrayAdapter<InsuranceData> {


    public InsuranceAdapterItem(@NonNull Context context,
                                int resource,
                                @NonNull List<InsuranceData> objects) {
    ...
    private View textView(int position, View convertView, ViewGroup parent) {
        ...
        holder.binding.setData(Objects.requireNonNull(getItem(position)).getPolicyTerm());
    ...
    public View initView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.binding.setData(Objects.requireNonNull(getItem(i)).getPolicyTerm());
        return holder.binding.getRoot();
    }
    ...
    @Nullable
    @Override
    public InsuranceData getItem(int position) {
